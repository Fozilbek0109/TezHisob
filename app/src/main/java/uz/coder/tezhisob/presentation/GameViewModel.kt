...
import uz.coder.tezhisob.domain.entity.GameResult
...
import uz.coder.tezhisob.domain.usecases.GenerateQuestionUseCase
import uz.coder.tezhisob.domain.usecases.GetGameSettingUseCase
import uz.coder.tezhisob.R
import javax.inject.Inject

class GameViewModel @Inject constructor(
    application: Application,
    val generateQuestionUseCase: GenerateQuestionUseCase,
    val getGameSettingUseCase: GetGameSettingUseCase,
) : ViewModel() {
